...
export const StartView = (): JSX.Element => {
  ...
  return <div className="main h-full flex justify-center flex-col items-center">
    ...
    <Link to="/create" className="button w-full h-12 bg-accent text-secondary mb-2 flex items-center justify-center">Neue Bierlympiade anlegen</Link>
    <Link to="/games" className="button w-full h-12 bg-accent text-secondary mb-2 flex items-center justify-center">Laufende Bierlympiade anzeigen</Link>
